    ...
    <section className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="border rounded-lg shadow p-4 bg-white text-black">
          <Image src="/products/tshirt1.jpg" alt="Classic Tee" width={500} height={300} className="rounded mb-4"/>
      ...
      <h1 className="text-4xl font-bold mb-8">T-Shirts Collection</h1>
            ...
            <Image src="/image1/jeans.jpg" alt="Jeans" width={600} height={400} className="mx-auto rounded mb-6" />
            <Image src="/image1/jeans1.jpg" alt="Jeans1 " width={600} height={400} className="mx-auto rounded mb-6" />
            <Image src="/image1/jeans.jpg" alt="Jeans" width={600} height={400} className="mx-auto rounded mb-6" />
